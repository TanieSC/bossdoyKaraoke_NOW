...
namespace bossdoyKaraoke_NOW.Models
{
    ...
    {
        static string m_bgVideoPath = AppDomain.CurrentDomain.BaseDirectory;
       ...
       // string path4 = m_bgVideoPath + @"VIDEO_EVENT\004.vob";
        ...
        string path1 = m_bgVideoPath + @"VIDEO_MTV\001.mp4";
        string path2 = m_bgVideoPath + @"VIDEO_MTV\002.mp4";
        string path3 = m_bgVideoPath + @"VIDEO_MTV\003.mp4";
        ...
        IMediaList m_media_list;
        IMediaListPlayer m_list_player;
        ...
        public void LoadDefaultVideoBackGround() {

            string[] p = new string[] { path1, path2, path3, path4 };

            if (m_player.IsPlaying) m_player.Stop();

            for (int i = 0; i < p.Length; i++)
            {
                m_media = m_factory.CreateMedia<IMediaFromFile>(p[i]);
