...
{
    public class Channel3Fx
    {
        private static VSTPROC m_VstProc;
        private static float _paramValue;
        private static float m_stripParamDefaultValue;
        private static bool m_isDefaultValue;
        ...
        public static void ShowInterface()
        {
            ...
            switch (Effects.GetorSetFx)
            {
                ...
                case Effects.Load.CHANNETSTRIP:
                    ...
                    _effectsInteface.LoadChannelStrips(PlayerControl.PrefsForm, PlayerControl.PrefsForm.channel3panel, 1, 434);
                    break;
            }
        ...
        public static float GetStripParamDefaultValue { get { return m_stripParamDefaultValue; } }
        public static bool IsDefaultValue { get; set; }
    }
}
