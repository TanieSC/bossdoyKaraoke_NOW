...
namespace bossdoyKaraoke_NOW.Models
{
    class WasapiDevice : Mixer
    {
        ...
        public static void SetDevice(int inputDevice, int outputDevice)
        {
            ...
            if (!BassInit)
            {
                ...
                // Bass.BASS_SetConfig(BASSConfig.BASS_CONFIG_UPDATEPERIOD, 0);
                 BassInit = Bass.BASS_Init(0, 44100, BASSInit.BASS_DEVICE_DEFAULT, IntPtr.Zero);

                // BassWasapi.BASS_WASAPI_Init(0, 48000, 2, BASSWASAPIInit.BASS_WASAPI_AUTOFORMAT, 0f, 0f, null,
                //    IntPtr.Zero);
            ...
            BassWasapi.BASS_WASAPI_Init(inputDevice, inputdeviceinfo.mixfreq, inputdeviceinfo.mixchans,
                BASSWASAPIInit.BASS_WASAPI_BUFFER | BASSWASAPIInit.BASS_WASAPI_SHARED, input.buflen, 0, _wasapiInProc, IntPtr.Zero);

            _instream = Bass.BASS_StreamCreatePush(inputdeviceinfo.mixfreq, inputdeviceinfo.mixchans,
                BASSFlag.BASS_SAMPLE_FLOAT | BASSFlag.BASS_STREAM_DECODE, IntPtr.Zero); // create a stream to receive the data
            // string fn = @"D:\tanie\musicradar-female-vocal-samples\musicradar-female-vocal-samples\rock\gotta slow down hard.wav";
            //string fn = @"D:\tanie\AUDIOTUTS_23_VoxProcessing\1 Raw Vocal.mp3";
          ...
          //  _outstream = MixerStreamCreate(outputdeviceinfo.mixfreq);
            //Player.Mixer = _outstream;
            ...
            BassWasapi.BASS_WASAPI_Init(outputDevice, outputdeviceinfo.mixfreq, outputdeviceinfo.mixchans,
                BASSWASAPIInit.BASS_WASAPI_BUFFER | BASSWASAPIInit.BASS_WASAPI_SHARED, output.buflen, 0, _wasapiOutProc, IntPtr.Zero);


            //Group 1 VST Effects ============================================================
            Channel1Fx.SetEffects(_stream[0]);
            ...
            BassMix.BASS_Mixer_StreamAddChannel(_outstream, _stream[0], 0);
        ...
        public static void MicVolumeTrack() {
            ...
            MicVolume = PlayerControl.MicVolumeScroll.Value * 0.01f;
        ...
        public static float Mic_Volume
        {
            ...
            {
                MicVolume = value;
                //Bass.BASS_ChannelSetAttribute(_stream[0], BASSAttribute.BASS_ATTRIB_VOL, value);
               // Bass.BASS_ChannelSetAttribute(_stream[1], BASSAttribute.BASS_ATTRIB_VOL, value);
              //  Bass.BASS_ChannelSetAttribute(_stream[2], BASSAttribute.BASS_ATTRIB_VOL, value);
        ...
        public static float ReverbMix
        {
            ...
            {
                Reverb = value;
                Bass.BASS_ChannelSetAttribute(_stream[3], BASSAttribute.BASS_ATTRIB_VOL, value);
                //BassWasapi.BASS_WASAPI_SetVolume(BASSWASAPIVolume.BASS_WASAPI_VOL_DEVICE | BASSWASAPIVolume.BASS_WASAPI_CURVE_WINDOWS, value);
