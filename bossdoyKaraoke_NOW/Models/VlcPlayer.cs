...
namespace bossdoyKaraoke_NOW.Models
{
    class VlcPlayer : IDisposable
    {
        ...
        IMedia m_media, m_media_preview;
       ...
       // private Implementation.Equalizer m_equalizer = new Implementation.Equalizer();
        ...
        public VlcPlayer()
        {
            ...
            if (videoDir == string.Empty || !Directory.Exists(videoDir)) videoDir = BGVideoPath + @"VIDEO_NATURE\";
        ...
        public void LoadDefaultVideoBG() {
          ...
          //  string[] p = new string[] { path1, path2, path3 };
            ...
            if (videoDir != string.Empty)
            {
                ...
                {
                    m_media_preview = m_factory.CreateMedia<IMediaFromFile>(videoPath[i]);
                    m_media_list.Add(m_media_preview);
                }
