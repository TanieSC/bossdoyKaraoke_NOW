        ...
        public static void ShowInterface()
        {
            ...
            switch (Effects.GetorSetFx)
            {
                ...
                case Effects.Load.CHANNETSTRIP:
                    ...
                    _effectsInteface.LoadChannelStrips(PlayerControl.PrefsForm, PlayerControl.PrefsForm.channel2panel, 1, 434);
                    break;
            }
        }
